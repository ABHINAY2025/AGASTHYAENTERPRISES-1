...
const InvoicePage: React.FC = () => {
  ...
  if (!invoiceData) return <div>No invoice data provided</div>;
  ...
  const renderPage = (pageNumber: number) => {
    ...
    const showFooter = shouldShowFooterOnPage(invoiceData.items.length, pageNumber);
            ...
            <div className="pt-3 text-sm">
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  <img className="w-36 mt-3 ml-24" src={stamp} alt="stamp" />
                </div>
              </div>
              ...
              <div className="flex justify-between mt-3 text-lg">
                ...
                <div>
                  <p className="text-[10px] text-right">This is a digitally signed document</p>
                  <h1 className="-mt-2">Authorized Signature</h1>
                </div>
              </div>
            </div>
          </div>
...
return (
  <div className="min-h-screen bg-gray-100 py-8">
    ...
    <div className="px-7 py-2 bg-blue-500 w-20 rounded-lg ml-10 hover:bg-blue-800 flex justify-center">
